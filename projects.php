...
<div class="cardon-row">
  <div class="cardon">
    <h3>PROJECT 1</h3>
    <p>The content about the first project will be visible here, whenever anyone wants to view it.</p>
  </div>
  <div class="cardon">
    <h3>PROJECT 2</h3>
    <p>The content about the second project will be visible here, whenever anyone wants to view it.</p>
  </div>
</div>
<div class="cardon-row">
  <div class="cardon">
    <h3>PROJECT 3</h3>
    <p>The content about the third project will be visible here, whenever anyone wants to view it.</p>
  </div>
